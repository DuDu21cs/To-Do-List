...
const standardTheme = document.querySelector(".standard-theme-btn");
const lightTheme = document.querySelector(".light-theme-btn");
const darkerTheme = document.querySelector(".darker-theme-btn");
...
if(color === "standard"){
    standardTheme.classList.add("active-theme");
}
else if(color === "light"){
    lightTheme.classList.add("active-theme");
}
else{
    darkerTheme.classList.add("active-theme");
}
  });
